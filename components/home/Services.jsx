...
export default function Services({ onContactClick }) {
  const services = [
    { id: '2D Services', param: '2d', icon: 'fa-pen-ruler', title: '2D', desc: 'Our team delivers clear, technically accurate drawings that help project stakeholders communicate design intent.' },
    { id: '3D Services', param: '3d', icon: 'fa-cube', title: '3D', desc: 'Our 3D BIM services help project teams identify issues early, streamline collaboration, and ensure accuracy.' },
    { id: '4D Services', param: '4d', icon: 'fa-clock', title: '4D', desc: 'We integrate project schedules with BIM models to simulate, optimize, and control construction sequencing.' },
    { id: 'Project Planning', param: 'pp-c', icon: 'fa-chart-gantt', title: 'Planning & Controls', desc: 'We support structured planning to enhance coordination and execution clarity across the project lifecycle.' },
    { id: 'BOQ Services', param: 'boq', icon: 'fa-calculator', title: 'BOQ', desc: 'We deliver accurate cost and quantity support to enhance financial transparency and procurement alignment.' },
    { id: 'Audit Services', param: 'audit', icon: 'fa-clipboard-check', title: 'Audit', desc: 'We ensure compliance, transparency, and technical accuracy across all critical project stages.' }
  ];
  ...
  return (
    <section className="container mx-auto px-6 py-20 relative overflow-hidden">
      ...
      {/* Services Grid with Horizontal Mobile Scroll */}
            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="relative overflow-hidden bg-zinc-900/40 backdrop-blur-xl border border-zinc-800 p-8 rounded-[2.5rem] transition-all duration-500 ease-out hover:-translate-y-3 hover:border-[#6EDD4D]/40 hover:shadow-[0_20px_40px_rgba(0,0,0,0.6),0_0_20px_rgba(110,221,77,0.1)] group flex flex-col items-center text-center h-full">
                  ...
                  <div className="w-20 h-20 rounded-2xl bg-zinc-950 border border-zinc-800 flex items-center justify-center mb-8 relative z-10 group-hover:bg-[#6EDD4D] group-hover:rotate-[10deg] transition-all duration-500">
                    <i className={`fa-solid ${service.icon} text-3xl text-[#6EDD4D] group-hover:text-zinc-950 transition-colors duration-500`}></i>
                  </div>
        ...
        <AnimatedSection animationClass="opacity-0 scale-0" delay={300}>
          <button
            ...
            className="
              ...
              duration-300 
              hover:scale-105 
              shadow-[0_0_20px_rgba(110,221,77,0.05)] 
              hover:shadow-[0_0_50px_rgba(110,221,77,0.2)] 
